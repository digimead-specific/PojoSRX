...
public class CapabilitySet {
    ...
    /**
     * This is an ugly utility method to convert an array of primitives to an array of primitive wrapper objects. This method simplifies
     * processing LDAP filters since the special case of primitive arrays can be ignored.
     *
